...
function generateFeedback(index) {
  ...
  const yr = tripStartTime.getFullYear();
  const mo = String(tripStartTime.getMonth() + 1).padStart(2, '0');
  const dy = String(tripStartTime.getDate()).padStart(2, '0');
  const tripId = `T${yr}${mo}${dy}_${String(index + 1).padStart(3, '0')}`;
